...
import { reportError, updateUnitsWithFileData } from '../ngrx-store/reducers/unit.reducer';
import { AppState } from '../ngrx-store/app-state';
import { updateDataFileName } from '../ngrx-store/reducers/settings.reducer';
import { updateUnitsProgress } from '../ngrx-store/reducers/unit-study-session.reducer';
...
export class AppDataService {
    ...
    this.appData$.subscribe(
      {
        ...
        next: (data: AppState) => {
          // check that the user has attempted to pick a file once, this is so the app does not try saving the data till user tried to pick a file
  ...
  async updateStore() {
    ...
    this.store.dispatch(updateUnitsProgress(appData.unitStudy.unitsStudySessions));
